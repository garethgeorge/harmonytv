...
class S3Backend {
  ...
  putBlock(srcPipe, mimetype = undefined) { // returns the block's id
    ...
    return new Promise((accept, reject) => {
      ...
      srcPipe.on('end', () => {
        ...
        console.log(`s3 collected all of the data, length: ${data.length}, objectId: ${objectId} key: ${config.cacheEncryptionKey}`);

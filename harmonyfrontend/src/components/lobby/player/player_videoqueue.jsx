 ...
 * @export
 */
class UiOverflowMenu extends shaka.ui.Element {
  /**
  ...
  createChildren_() {
    for (let i = 0; i < this.config_.overflowMenuButtons.length; i++) {
      ...
      if (shaka.ui.OverflowMenu.elementNamesToFactories_.get(name)) {
        const factory = shaka.ui.OverflowMenu.elementNamesToFactories_.get(
          name
        );
  ...
  updateAriaLabel_() {
    ...
    this.overflowMenuButton_.setAttribute(
 ...
 * @final
 */
UiOverflowMenu.Factory = class {
  /** @override */
  create(rootElement, controls) {
    return new UiOverflowMenu(rootElement, controls);
  }
};
